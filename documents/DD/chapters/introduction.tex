...
To achieve this, the system is organized with a two tiers architecture in which a presentation layer runs on a client, and a data and application layers get stored on a server.
