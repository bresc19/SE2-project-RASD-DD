...
This would be easy-manageble because a \textbf{receptionist} handles the booking and advises the customers with the best shopping option. %as clients' necessary. 
...
The user can also manage (either delete or postpone), in a later moment, his reservation by calling the same number of the registration.
When the turn has been called, the user will be noticed through an SMS.
...
One of the most important function is the \textit{Queue Manager} because it must avoid the users waiting too much their turn in the case of a wrong use of notifications. 
...
\item \textit{User in shop}: he’s a client who has taken his own queue ticket or he has booked a visit. After that he is arrived at the supermarket, he has scanned the QR code and he has entered into the shop.
\end{itemize}
