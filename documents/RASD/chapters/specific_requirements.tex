...
\begin{figure}[H]
  \centering
  \subfloat[Page 1.]{\includegraphics[scale=0.288]{images/mockup/reg1.png}\label{fig:f1}}
  \hfill
  \subfloat[Page 2]{\includegraphics[scale=0.32]{images/mockup/reg2.png}\label{fig:f2}}
...
It's important that the server has enough resources to accept a large number of request which we estimate a maximum of 1000.
\bigskip
