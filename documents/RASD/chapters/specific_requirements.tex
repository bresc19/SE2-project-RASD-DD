...
\begin{figure}[H]
  \centering
  \subfloat[Page 1.]{\includegraphics[scale=0.260]{images/mockup/reg1.png}\label{fig:f1}}
  \hfill
  \subfloat[Page 2.]{\includegraphics[scale=0.260]{images/mockup/reg2.png}\label{fig:f2}}
...
\begin{figure}[H]
  \centering
  \subfloat[Delay confirmation of a Reservation]{\includegraphics[scale=0.30]{images/mockup/qr1.png}\label{fig:f1}}
  \hfill
  \subfloat[Cancellation confirmation of a Visit]{\includegraphics[scale=0.30]{images/mockup/qr7.png}\label{fig:f2}}
...
\begin{figure}[H]
  \centering
  \subfloat[A notification is sent to a Smart User to inform him to leave in order to reach the market in time.]{\includegraphics[scale=0.50]{images/mockup/notify1.png}\label{fig:f1}}
  \hfill
  \subfloat[An SMS is sent to a Mobile User with booking information of his Visit. In particular contains the Booking's schedule and the Identification Code to submit.]{\includegraphics[scale=0.50]{images/mockup/visit_SMS.png}\label{fig:f2}}
...
\begin{figure}[H]
  \centering
  \makebox[\linewidth]{
  \includegraphics[scale=0.50]{diagrams/UseCaseUser.png}}
