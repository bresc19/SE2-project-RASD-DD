...
\subsection{World}
It's the portion of system to be developed. The main \textbf{World Phenomena} are:
...
\subsection{Machine}
It represents the portion of system to be developed. The main \textbf{Machine Phenomena} are:
\begin{itemize}
...
\begin{itemize}
\item Book/delete a visit;
\item Take a virtual ticket;
\item Send a notice;
\item Send a SMS;
\end{itemize}
