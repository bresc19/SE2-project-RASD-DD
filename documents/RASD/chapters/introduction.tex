...
Finally a alphanueric string will be provided to Mobile Users due to enter and exit form the market. Instead, this string for Smart User is converted in two-dimensional bar code using the standard QRCode. This must be submitted at the entry of the market.
Instead, the third one is only for aged customers older than 65 years old, but with limitations. For instance they can go grocery shopping only in certain days and time slots. 
...
\item Internet connection / mobile operator;
