...
In particular, in order to avoid to wait in line, Users will be allerted by a \textbf{notification} (Smart Users) or a \textbf{SMS} (Mobile Users). These inform them about his time schedule required to reach the market in time.
...
\item \textbf{CLup}: It's the application described in this document. It's an application used to make and manage Booking in order to go grocery shopping;
[TODO AGGIUNGERE CLUP OPERATOR]
\item \textbf{User}: Generic customer who plan to shop in the market. He could be a Smart or Mobile User;
\item \textbf{Smart User}: User who has got a smartphone which has CLup App. So he's able to manage bookings by himself;
