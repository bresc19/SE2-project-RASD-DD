...
\begin{figure}[H]
  \centering
  \makebox[\linewidth]{
  \includegraphics[scale=0.40]{diagrams/component_diagram.png}}
...
\begin{figure}[H]
  \centering
  \makebox[\linewidth]{
  \includegraphics[scale=0.43]{diagrams/entity_Diagram.png}}
...
For the client's side, CLup and CLup Operator will be hosted respectively on a mobile and desktop device. Softwares will be designed both following a cross-platform development. 
